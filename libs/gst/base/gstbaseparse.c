...
gst_base_parse_parse_frame (GstBaseParse * parse, GstBaseParseFrame * frame)
{
	    ...
	    if (!must_approximate_dts
	       ...
	       * approximated here */
	    	GST_WARNING_OBJECT  (parse,
	          "Approximate PTS - Found DTS (%" GST_TIME_FORMAT ") > PTS (%" GST_TIME_FORMAT
	  ...
	  if (must_approximate_dts) {
	    if (!must_approximate_pts
	       ...
	       * approximated here */
	    	GST_WARNING_OBJECT (parse,
	          "Approximate DTS - Found DTS (%" GST_TIME_FORMAT ") > PTS (%" GST_TIME_FORMAT
	  ...
	  if (GST_CLOCK_TIME_IS_VALID (GST_BUFFER_PTS (buffer))
		...
		GST_WARNING_OBJECT (parse,
	        "Change PTS - Found DTS (%" GST_TIME_FORMAT ") > PTS (%" GST_TIME_FORMAT
	        "), set PTS = DTS", GST_TIME_ARGS (GST_BUFFER_DTS (buffer)),
	        GST_TIME_ARGS (GST_BUFFER_PTS (buffer)));
	    GST_BUFFER_PTS (buffer) = GST_BUFFER_DTS (buffer);
	  }
